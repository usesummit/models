...
AI doesn't make this benefit obsolete, because AI can also generate SEL.  By being more compact, it is less likely to contain errors and faster to generate than its broader-purpose counterparts.
